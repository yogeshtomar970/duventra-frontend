      ...
      <div className="student-container">
        ...
        >
          ...
          <SearchHeader
            ...
            onToggleSearch={setSocFollowSearchOpen}
            searchValue={socFollowSearch}
            onSearchChange={setSocFollowSearch}
            onClear={() => setSocFollowSearch("")}
          />
          <div className="horizontal-scroll">
            {filterBy(societyFollowing, "societyName", socFollowSearch)
              .length === 0 ? (
              <p style={{ color: "#999", fontSize: 13, margin: 0 }}>
                No society following yet
              </p>
            ) : (
              filterBy(societyFollowing, "societyName", socFollowSearch).map(
                (item, i) => (
                  <SocietyMemberCard
                    key={i}
                    item={item}
